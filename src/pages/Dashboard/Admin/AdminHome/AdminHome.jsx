...
const AdminHome = () => {
    ...
    return (
        <div>
            <h2 className="text-3xl font-semibold my-10">Hi, Welcome Back {user?.displayName}</h2>
            <div className="flex justify-evenly mb-16">
                {/* Revenue */}
                <div className="flex items-center gap-5 bg-gradient-to-r from-[#BB34F5] to-[#FCDBFF] py-8 px-12 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
                        <g clipPath="url(#clip0_4_196)">
                ...
                {/* Customers */}
                <div className="flex items-center gap-5 bg-gradient-to-r from-[#D3A256] to-[#FDE8C0]  py-8 px-12 rounded-md">
                    ...
                    <div className="text-white">
                        <h2 className="text-4xl font-bold">{data?.users}</h2>
                        <h4 className="text-2xl mt-2">Customers</h4>
                    </div>
                </div>
                {/* Products */}
                <div className="flex items-center gap-5 bg-gradient-to-r from-[#FE4880] to-[#FECDE9]  py-8 px-12 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
                    ...
                    <div className="text-white">
                        <h2 className="text-4xl font-bold">{data?.menuItems}</h2>
                        <h4 className="text-2xl mt-2">Products</h4>
                    </div>
                </div>
                {/* Orders */}
                <div className="flex items-center gap-5 bg-gradient-to-r from-[#6AAEFF] to-[#B6F7FF]  py-8 px-12 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
                    ...
                    <div className="text-white">
                        <h2 className="text-4xl font-bold">{data?.orders}</h2>
                        <h4 className="text-2xl mt-2">Orders</h4>
                    </div>
                </div>
            </div>
            {/* charts */}
